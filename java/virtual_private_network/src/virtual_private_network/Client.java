...
public class Client extends Crypto {
	...
	private void authenticate() {
		...
		//creates public key from previously attained server's public key string
		PublicKey pbKey;
		try {
		...
		VirtualPrivateNetwork.log("Authenticating with server..." + '\n');
		...
		//encrypts the encryption key with the server's public key
		...
		//extracts the encryption key used to encrypt the message, uses client's private key
		...
		//decrypts the message with the encryption key found before and then the server's public key
